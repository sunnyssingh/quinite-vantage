-- ================================================================
-- FIX BROKEN USERS - Manual Repair Script
-- ================================================================
...
-- These are users who have a profile but no organization
SELECT 
    p.id,
    p.email,
    p.full_name,
...
BEGIN
    ...
    LOOP
        ...
        -- Create audit log entry (corrected schema)
        ...
        RAISE NOTICE 'Fixed user: % - Now linked to org: %', broken_user.email, new_org_id;
    END LOOP;
...
-- Should show: still_broken = 0

-- ================================================================
-- View the fixed users
-- ================================================================
